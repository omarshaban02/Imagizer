...
class ImageEditor(QMainWindow, Ui_MainWindow):
    ...
    def handle_slider_labels(self):
        slider_label_map = dict()
        sliders = [self.slider_intensity, self.slider_mean, self.slider_std, self.slider_salt, self.slider_pepper]
        labels = [self.label_intensity, self.label_mean, self.label_std, self.label_salt, self.label_pepper]
        for slider, label in
