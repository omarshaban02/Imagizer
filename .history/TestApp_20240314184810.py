...
class ImageEditor(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        plotwidget_set = (self.wgt_input_img, self.wgt_input_img_greyscale, self.wgt_output_img,
                          ...
                          self.wgt_histo_colored, wgt)

        # Create an image item for each plotwidget
        image_item_set = (self.item_filter_input, self.item_filter_output, self.item_filter_greyscale,
    ...
    def load_img_file(self, image_path):
        ...
        self.display_image(self.item_filter_input, self.loaded_image)
        self.display_image(self.item_filter_greyscale, greyscale_image)
    ...
    def setup_plotwidgets(self):
        ...
        for plotWidget, imgItem in zip([self.wgt_input_img, self.wgt_input_img_greyscale, self.wgt_output_img,
                                        self.wgt_],
                                       [self.item_filter_input, self.item_filter_greyscale, self.item_filter_output]):
