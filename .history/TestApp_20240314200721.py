...
class ImageEditor(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.radio_list_smooth = [self.radio]
    ...
    def set_radio_button_connections(self):        
        ...
        for noise_radio in self.radio_dict_edges.keys():
            noise_radio.toggled.connect(lambda: self.set_stacked_widget(self.stackedWidget_edges, self.radio_dict_edges))
