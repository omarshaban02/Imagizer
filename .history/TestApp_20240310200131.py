...
class ImageEditor(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.setupUi(self)
        img_item_list = (pg.ImageItem() for item in [self.img_item_input, self.img_item_output, self.img_item_greyscale])
        self.img_item_input, self.img_item_output, self.img_item_greyscale = pg.ImageItem()
