...
class ImageEditor(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        (self.item_filter_input, self.item_filter_output, self.item_filter_greyscale,
         ...
         self.item_hybrid_FT_1, self.item_hybrid_FT_2, self.item_hybrid_FT_) = (pg.ImageItem() for i in range(3))
